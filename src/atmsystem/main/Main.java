package atmsystem.main;

import atmsystem.database.DatabaseHandler;
import atmsystem.gui.BankingSystemGUI;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            Bank bank = new Bank("ATM Bank", "Main Branch", "ATM001");
            ...
            if (!DatabaseHandler.testConnection()) {
                JOptionPane.showMessageDialog(null,
                        "Could not connect to the database.\n\n"
                                ...
                                + "2. Make sure the 'atm_system' database has been created\n"
                                + "   by importing database/atm_system.sql.\n"
