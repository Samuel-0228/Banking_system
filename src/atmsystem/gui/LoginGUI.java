...
import atmsystem.exceptions.InvalidLoginException;
...
public class LoginGUI extends JFrame {
    ...
    public LoginGUI() {
        ...
        titleBlock.add(title, BorderLayout.SOUTH);
        ...
        gc.gridx = 0; gc.gridy = 1; gc.weightx = 0; gc.anchor = GridBagConstraints.LINE_END;
